...
import { downloadFile, getFileExt } from '@b/utils/file'
...
import { CodePreview, preview } from '@b/api/generator/gen-table'
...
import { FdCodeEditorInst } from '@b/components/code-editor/code-editor'
