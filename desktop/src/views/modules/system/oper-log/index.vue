        ...
        <el-table-column align="center" fixed="right" header-align="center" label="操作" width="100">
          <template #default="scope">
            ...
            <el-tooltip :show-after="500" content="删除" placement="top">
              <el-button v-show="auth('system:operLog:delete')" class="tb-act-btn" plain size="small" type="danger" @click="del(scope.row)">
...
import { OperLog, operLogDel, operLogDicts, operLogExport, operLogFields, operLogList, operLogQuery } from '@b/api/system/oper-log'
