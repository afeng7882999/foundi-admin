<template>
  <el-dialog ref="moduleRoot" :model-value="true" draggable :style="docMinHeight" class="system-page-dictItem fd-page">
...
import { DictItem, dictItemDel, dictItemExport, dictItemFields, dictItemList, dictItemParams, dictItemQuery } from '@b/api/system/dict-item'
import Edit from './edit.vue'
import useExpandTransition from '@b/hooks/use-expand-transition'
import { useRoute, useRouter } from 'vue-router'
import { useStore } from '@/store'
import { dictGetOne } from '@b/api/system/dict'
