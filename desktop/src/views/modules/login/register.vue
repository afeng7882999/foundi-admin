      ...
      <div class="page-register-card vivify fadeIn duration-300">
        ...
        <div class="register-card-content">
          ...
          <div class="card-content">
            <el-form
              ref="registerForm"
              :model="state.registerData"
              :rules="state.submitRules"
              class="card-content__form"
              label-width="80px"
            >
...
import { validEmail, validPassword, validUsername } from '@b/utils/validate'
import { checkEmail, checkUsername, register } from '@b/api/system/login'
