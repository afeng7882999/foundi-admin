import { getDateListByRange, getLastDateList } from '@b/utils/time'
import { ContentStat } from '@b/api/dashboard'
...
export const getContentStat = async (range = 7 as ContentStatRange): Promise<ContentStat[]> => {
  ...
  const reads = [
    768, 471, 853, 960, 1101, 1785, 929, 1594, 896, 845, 694, 597, 1249, 978, 787, 483, 479, 746, 857, 1049, 405, 372, 943, 1724, 971, 470,
    1382, 875, 935, 1353
  ]
  const likes = [
    441, 65, 516, 569, 636, 1266, 402, 1089, 558, 462, 468, 219, 1016, 581, 468, 241, 246, 308, 480, 658, 104, 146, 540, 1282, 629, 162,
    904, 604, 544, 983
  ]
